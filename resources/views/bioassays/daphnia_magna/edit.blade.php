                            ...
                            <tr>
                                <td>
                                    <input type="text" class="form-control form-control-sm navigable bg-light" 
                                           name="sample" 
                                           value="{{ old('sample', $daphnia_magna->sample) }}" 
                                           readonly>
                                </td>
                                <td>
                ...
                <div class="timer-container my-4 p-3" id="preliminaryTimerContainer">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        <div class="d-flex align-items-center gap-3">
                            <button type="button" class="btn btn-primary btn-lg" id="btnStartPreliminary" onclick="startTimer('preliminary')">
        ...
        <div class="card mb-4 shadow-sm border-0" style="border-radius: 10px;">
            ...
            <div class="card-body bg-light p-3">
                ...
                <div class="timer-container my-4 p-3" id="definitiveTimerContainer">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        <div class="d-flex align-items-center gap-3">
                            <button type="button" class="btn btn-success btn-lg" id="btnStartDefinitive" onclick="startTimer('definitive')">
