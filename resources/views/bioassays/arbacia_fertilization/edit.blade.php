...
<div class="container-fluid px-4">
    ...
    @if(auth()->user()->hasRole(['Manager', 'Area Manager']) && !$arbacia_fertilization->validated_at)
        <form id="validateBioassayForm" action="{{ route('arbacia-fertilization.validate', $arbacia_fertilization->id) }}" method="POST" style="display:none">
            @csrf
            @method('PATCH')
        </form>
    @endif
