...
<div class="container px-4">
    ...
    @if(auth()->user()->hasRole(['Manager', 'Area Manager']) && !$tisbe_longicornis_water->validated_at)
        <form id="validateBioassayForm" action="{{ route('tisbe-longicornis-water.validate', $tisbe_longicornis_water->id) }}" method="POST" style="display:none">
            @csrf
            @method('PATCH')
        </form>
    @endif
