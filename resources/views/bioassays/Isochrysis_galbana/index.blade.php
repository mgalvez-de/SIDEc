...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-secondary">Gestión de Muestras Isochrysis</h1>
        <a href="{{ route('isochrysis-galbana.create') }}"
                    ...
                    <tbody>
                        @forelse($bioassays as $bioassay)
                            <tr>
                                ...
                                <td>{{ $bioassay->created_at->format('Y-m-d H:i') }}</td>
                                <td>
                                    <a href="{{ route('isochrysis-galbana.edit', $bioassay) }}"
                                       class="btn btn-sm btn-light text-dark border btn-action">
                                       Continuar Análisis
                                    </a>
                                </td>
                        ...
                        @forelse($bioassays as $bioassay)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('isochrysis-galbana.destroy', $bioassay) }}" method="POST" class="d-inline form-delete">
                                        @csrf @method('DELETE')
