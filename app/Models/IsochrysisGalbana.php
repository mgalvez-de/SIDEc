...
class IsochrysisGalbana extends Model
{
    use HasFactory;

    protected $table = 'isochrysis_galbana';
    ...
    protected $casts = [
        ...
        'initial_inoculum_vol' => 'decimal:2',
        'rc24h'                => 'decimal:2',
        'rc48h'                => 'decimal:2',
        'rc72h'                => 'decimal:2',
        'rc196h'               => 'decimal:2',
