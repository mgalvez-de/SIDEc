...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::dropIfExists('daphnia_magna_templates');

        Schema::create('daphnia_magna_templates', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('preliminary_reconstituted_water_date')->nullable();
            $table->decimal('preliminary_sample_ph', 8, 2)->nullable();
            ...
            $table->date('definitive_reconstituted_water_date')->nullable();
